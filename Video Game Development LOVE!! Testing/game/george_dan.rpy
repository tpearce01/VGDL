...
label gd_scene1:
    ...
    mc "(Hey... He’s that guy that I bumped into earlier today!)"
    ...
    gd "This first meeting may not be too exciting, but I promise you that there will be invaluable experiences to gain, many joyous moments to come, and new friends to share those moments with. So with that said, I hope that you will enjoy your journey here to the fullest…"
    ...
    mc "(Oh it's ren! I haven't seen her since high school. She was like my bigger sister back in high school. She would always protect me.)"
    ...
    ren "You should definitely join! Take time away from your busywork and enjoy some time with your biggos here!"
...
label gd_scene2:
    ...
    mc "Yeah dad, I know. I’ve just been a bit tight on my schedule, but I’ll be sure to stock up the fridge with food."
    ...
    dad "Hahah, but yeah why the heck not? You guys probably met each other before."
    ...
    mc "(After I finished eating, I took off my clothes, got into my bed, and put on my headphones. The soothing music starts to play, as I begin to do some of my work.)"
    mc "(Eventually, my eyes start to tire. I put my work aside, laid down on, looked at the window, and as I listened to the music, his voice...started to run through my mind.)"
    mc "(I really want to ask him…)"
    mc "(Hey... you…)"
    "(*Beep Beep Beep*)"
    mc "OH SHOOT!! IT’S 8:15!"
    mc "(I won’t make it to my 8 a.m class!! Damn… I forgot to reset my alarm.)"
    mc "(Disappointed and sad, I slammed my head back into my pillow.)"
    return
...
label gd_scene3:
    ...
    with hpunch
    mc "(Suddenly I bump into someone.)"
    ...
    menu gd_menu1:
        ...
        "Hand back the bottle,say nothing, and walk away": #(worst)
            mc "(I immediately hand back the bottle and nervously walk off without saying a word.)"
            gd "Thank y..."
        "Get dramatic and tell him that he’s the worst kind of guy":  #(middle)
            ...
            mc "(I start to quickly walk away.)"
        "Pretend to accidentally trip and sees if he catches you": #(best)
            mc "Here’s your bott…"
            mc "(As I return the bottle to him, my legs start to feel weak. Suddenly, as if a ghost had possessed me, my legs stumble and I fell toward him.)"
            gd "Oi, Are you okay?"
            mc "(My mind went blank and I just blocked out all the noises. The only thing that I can think of is how his arms are holding onto mine.)"
            mc "(He looks so tall and handsome close up and he smells nice too… Wait what?)"
            mc "(Suddenly, I snap out of my delusional state and realize what had just happened.)"
            mc "Hahaha! I’m very sorry!"
            mc "(After nervously apologizing, I got up and quickly walked away.)"
    ...
    mc "(I sat down and then as I unpack my stuff, I look across from me and he was there again!)"
    ...
    mc "(I quickly hid my face behind my textbook before he could notice me.)"
    ...
    menu gd_menu2:
        ...
        "Definitely peek": #(best)
            ...
            "(you peek at him)"
            mc "(Wow.... His face, resting gently on his silky fingers. He looks so elegant like a beautiful swan resting alongside a riverbank…)"
            ...
            mc "(I gently put my book down, with my face looking down. I then softly yawn.)"
            mc "(If he yawns then that means that he’s definitely looking at me! Hehe, I’m a genius!)"
            mc "(I slightly peek and he yawns!)"
            mc "HA I KNEW IT!"
            "(gd gives a slight chuckle)"
            mc "(Did he just smirk at me?)"
            "(The people in the room turns and looks at you except for gd)"
    ...
    "(You study and a few hours pass by)"
    ...
    mc "Yeah, I had a long and stressful day."
    ...
    menu gd_menu3:
        ...
        "Yes, and make sure you show him who’s boss": #(Best Choice + Bonus)
            ...
            mc "(With force, I pass the ball to him.)"
            ...
            "(gd holds up an umbrella over your head from behind)"
            ...
            mc "(Huh… what?!?!)"
            mc "(I turn my head to look at him… Who is this guy.)"
            
            #settings: road?
            mc "(It was turning night. We walk home in silence as the rain falls. The sound of the rain brought a soothing quietness, but it did not bring solitude.)" 
            mc "(He stood next to me, with his umbrella above us as we walk through our reflection on the concrete.)"
            mc "(The quietness wasn’t awkward between us, but instead it felt… comforting, as if two friends had reunited after years of isolation…)"
            mc "(No words needed. The sound of the rain spoke for us.)"
            mc "(Once we arrived in front of my place, I turn to look up at him.)"
            mc "Uh-um.. Thanks for walking me home."
            mc "(He looks me in the eyes and smiles.)"
            mc "(I turn around and start to walk away.)"
            gd "By the way. May I ask for you name?"
            #[Player Option 3.1(bonus)]
            menu gd_menu3_1:
                "Run at him and whisper in his ears": #(1st best)
                    mc "(I turn around and walk up to him. With my hands on his shoulders I whispered…)"
        ...
        "Nah, just play ball and ignore him": #(Worst Choice) (3.2)
            ...
            mc "(I slowly sunk my head under the water.)"
